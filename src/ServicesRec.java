...
public class ServicesRec extends javax.swing.JFrame {
 ...
 private void Get_Data(){
       String sql="select ServiceID as 'Service ID', ServiceName as 'Service Name',ServiceDate as 'Service Date',WorkerID as 'Worker ID',WorkerName as 'Worker Name',ServiceCharges as 'Service Charges' from services";
       try{         
    ...
    private void txtTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtTableMouseClicked
       try{
           ...
           String sql="Select * from workerregistration,Services where Services.workerID=workerregistration.workerID and ServiceID=" + table_click  + "";
            pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
                this.hide();
                ...
                String add2=rs.getObject("ServiceDate").toString();
                java.util.Date dat = new SimpleDateFormat("yyyy-MM-dd").parse(add2);
                frm.txtServiceDate.setDate(dat);
                
                String add3=rs.getString("workerName");
                frm.txtName.setText(add3);
                String add4=rs.getString("workerID");
                frm.txtWorkerID.setText(add4);
